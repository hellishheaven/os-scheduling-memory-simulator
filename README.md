...
Round Robin improves response time but may increase overhead if the quantum is too small.
...
Thrashing occurs when the total working set exceeds available memory.
